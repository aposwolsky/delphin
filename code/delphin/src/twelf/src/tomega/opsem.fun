 ...
 (* matchSub (t1, t2) = ()
    ...
    *)
    ...
    and matchSub (Psi, _, T.Shift _) = () (* By Invariant *)
	  ...
	  ( matchSub (Psi, t1, t2);
	   Unify.unify (T.coerceCtx Psi, (U1, I.id), (I.Root (I.BVar (I.Fixed k), I.Nil), I.id)) handle Unify.Unify _ => raise NoMatch)

      | matchSub (Psi, T.Dot (T.Idx k, t1), T.Dot (T.Exp U2, t2)) =  
	  ( matchSub (Psi, t1, t2); 
	   Unify.unify (T.coerceCtx Psi, (I.Root (I.BVar (I.Fixed k), I.Nil), I.id), (U2, I.id)) handle Unify.Unify _ => raise NoMatch )
