  ...
  local 
    ...
    *)
    ...
    and inferExpW (G, (I.Uni (L), _)) = (I.Uni (inferUni L), I.id)
      ...
      | inferExpW (G, (I.EVar(r (* ref NONE *), _, V, _), s)) = (V,s) (* ABP:  Added EVars *)
    ...
    *)
    and inferSpine (G, (I.Nil, _), Vs) = Vs
	  ...
	  (* ABP:  BUG.. need to do dotEta  -- May 25, 07
	   * (checkExp(G, (U, s1), (V1, s2));
	   * inferSpine (G, (S, s1), Whnf.whnf (V2, I.Dot (I.Exp (I.EClo (U, s1)), s2))))
	   *)
	  (checkExp(G, (U, s1), (V1, s2));
	   inferSpine (G, (S, s1), Whnf.whnf (V2, Whnf.dotEta (I.Exp (I.EClo (U, s1)), s2))))
    ...
    *)
    and inferCon (G, I.BVar (I.Fixed k')) = 
        let 
	...
	in
      ...
      | inferCon (G, I.FVar (_, _, V, s)) = I.EClo(V, s) (* ABP -- added FVars *)
