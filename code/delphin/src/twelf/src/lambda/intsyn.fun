...
struct
  type isParam = bool                   (* to tell if FVar is a parameter *)
  ...
  *)
  ...
  | FVar  of name * isParam * Exp * Sub	(*     | F[s]                 *)
  ...
  *)
  ...
  fun newEVarPruneNdec (G, V) =
	  ...
	  fun strengthen (Shift n (* = 0 *), Null) = Null
	    ...
	    | strengthen (Dot (Undef, t), Decl (G, D)) = strengthen (t, G)
	    | strengthen (Shift n, G) = strengthen (Dot (Idx (n+1), Shift (n+1)), G)
