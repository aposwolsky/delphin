...
sig
  ...
  val etaExpand : IntSyn.Exp * (IntSyn.Exp * IntSyn.Sub) -> IntSyn.Exp

  (* Weak head normalization *)
  val whnf : IntSyn.eclo -> IntSyn.eclo
  val whnfBVar : IntSyn.BoundVar * IntSyn.Sub  -> IntSyn.BoundVar * IntSyn.Sub
  val findIndex : int * IntSyn.Sub -> int option
  ...
  val normalizeSub: IntSyn.Sub -> IntSyn.Sub
