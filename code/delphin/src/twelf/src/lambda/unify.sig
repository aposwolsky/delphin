...
sig
  ...
  val unifyG : IntSyn.dctx * IntSyn.dctx * IntSyn.eclo * IntSyn.eclo -> unit	(* generalized for Gglobal *)
  ...
  val invertExp : IntSyn.Dec IntSyn.Ctx * IntSyn.Dec IntSyn.Ctx * IntSyn.eclo * IntSyn.Sub
                  * IntSyn.Exp option ref
                  -> IntSyn.Exp

  val weakenSub : IntSyn.Dec IntSyn.Ctx * IntSyn.Sub * IntSyn.Sub -> IntSyn.Sub

  val pruneExp : IntSyn.Dec IntSyn.Ctx * IntSyn.Dec IntSyn.Ctx * IntSyn.eclo * IntSyn.Sub
                  * IntSyn.Exp option ref
                  -> IntSyn.Exp
  ...
  val unifiableG : IntSyn.dctx * IntSyn.dctx * IntSyn.eclo * IntSyn.eclo -> bool
