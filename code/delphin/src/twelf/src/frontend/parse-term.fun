...
struct
  ...
  local
    ...
    fun idToTerm (L.Lower, ids, name, r) = ExtSyn.lcid (ids, name, r)
      ...
      | idToTerm (L.UpperParam, ids, name, r) = ExtSyn.pid (ids, name, r) (* L.UpperParam only generated by Delphin *)
          ...
          let
            val dec = (case yOpt
                         of NONE => ExtSyn.dec0 (x, Paths.join (r0, r))
                          | SOME y => ExtSyn.dec (x, y, NONE, Paths.join (r0, r)))
	  ...
	  val (f'', r2) = stripRBrace f'
          val d = (case yOpt
                       of NONE => ExtSyn.dec0 (x, Paths.join (r, r2))
                        | SOME y => ExtSyn.dec (x, y, NONE, Paths.join (r, r2)))
	in
	  (d, f'')
	end
