          ...
          (
            ...
            gtAddID :=
              installF (ConDec ("+>", NONE, 2, Normal,
                                pi ("X", number(),
                                    pi ("Y", number(),
                                        pi ("Z", number(),
                                            arrow (gt (Root (BVar (Fixed 3), Nil),
                                                       Root (BVar (Fixed 2), Nil)),
                                                   gt (plus (Root (BVar (Fixed 4), Nil),
                                                             Root (BVar (Fixed 2), Nil)),
                                                       plus (Root (BVar (Fixed 3), Nil),
                                                             Root (BVar (Fixed 2), Nil))))))),
                                Type),
                        NONE, nil);
            ...
            geqAddID :=
              installF (ConDec ("+>=", NONE, 2, Normal,
                                pi ("X", number(),
                                    pi ("Y", number(),
                                        pi ("Z", number(),
                                            arrow (geq (Root (BVar (Fixed 3), Nil),
                                                        Root (BVar (Fixed 2), Nil)),
                                                   geq (plus (Root (BVar (Fixed 4), Nil),
                                                              Root (BVar (Fixed 2), Nil)),
                                                        plus (Root (BVar (Fixed 3), Nil),
                                                              Root (BVar (Fixed 2), Nil))))))),
                                Type),
            ...
            gtGeqID :=
              installF (ConDec (">>=", NONE, 2, Normal,
                                pi ("X", number(),
                                    pi ("Y", number(),
                                        arrow (gt (Root (BVar (Fixed 2), Nil),
                                                   Root (BVar (Fixed 1), Nil)),
                                               geq (Root (BVar (Fixed 3), Nil),
                                                    Root (BVar (Fixed 2), Nil))))),
                                Type),
                        NONE, nil);
