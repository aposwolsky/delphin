...
struct
  ...
  local 
    ...
    *)
    ...
    (* etaContract (U, n) = k
       ...
       Invariant: G, V1,..., Vn |- U : V for some G, Vi, V.
                  U in NF
    *)
    fun etaContract (I.Root (I.BVar(I.Fixed k), S),  n) =
        if k > n
    ...
    *)
    fun freeExpN (D, d, mode, I.Root (I.BVar (I.Fixed k), S), occ, strictFun) =
    ...
    *)
    fun nonStrictExpN (D, I.Root (I.BVar (I.Fixed k), S)) =
    ...
    *)
    fun updateExpN (D, I.Root (I.BVar (I.Fixed k), S), u) =
    ...
    *)
    ...
    (* groundExpN (D, mode, U, occ)  = u
       ...
       (occ and mode are used in error messages)
    *)
    fun groundExpN (D, mode, I.Root (I.BVar (I.Fixed k), S), occ) =
