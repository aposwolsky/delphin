...
structure DelphinElab : DELPHIN_ELABORATOR =
  ...
  (* Here we build up LF Reconstruction job and send it to LF *)
   ...
   (* ***************************************************************************************************** *)
   (* 
    * Second Phase:  Update the type information in DelphinIntermediateSyntax while performing abstraction
   ...
   (* ***************************************************************************************************** *)
   (* updateExp(smartInj, G, E, Tresult, K, allowVars) = (E', K')
    * If G |- E : Tresult
    * and all Vars in G are contained in K
    * If allowVars then leftover EVars are added to K to form K', otherwise K' = K.
    * E' is the converted form.
    *)
   (* ***************************************************************************************************** *)

  and coerceExp (DI.Quote M) = 
    ...
    | coerceExp (DI.VarInt (r, i)) = I.Idx i
    | coerceExp _ = I.Undef
